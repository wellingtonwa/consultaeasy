...
export class AgendaAddCompromisso extends React.Component<any, any> {
  ...
  render() {
    const { loading, isNew, compromisso, showModal, handleCloseFunction, handleSaveCompromisso } = this.props;
    return (
          ...
          : <AvForm model={isNew ? {} : compromisso} onSubmit={handleSaveCompromisso}>
            <ModalBody>
              ...
              <AvGroup>
                ...
                <AvInput type="datetime-local" className="form-control" value={compromisso.start} name="start" />
              </AvGroup>
            </ModalBody>
            <ModalFooter>
